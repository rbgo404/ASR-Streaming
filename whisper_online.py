# This script is based on code from the 'whisper_online.py' file in the following repository:
# URL: https://github.com/ufal/whisper_streaming
# This script extends the functionality provided by 'whisper_online.py' to stream the tokens as they are being generated.
...
class FasterWhisperASR(ASRBase):
    ...
    def load_model(self, modelsize=None, cache_dir=None, model_dir=None):
        ...
        print("Loading the model and dir path:",model_size_or_path,flush=True)
